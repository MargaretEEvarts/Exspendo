    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <form className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg max-w-md w-full space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <input
            type="text"
            className="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={username}
        ...
        <button type="submit" className="w-full bg-blue-500 dark:bg-blue-700 text-white py-3 rounded-lg shadow-md hover:bg-blue-600 dark:hover:bg-blue-800 transition duration-300">
          Login
        </button>
        <div className="text-center">
          <p className="text-gray-600 dark:text-gray-400">
            Don't have an account?{' '}
            <Link to="/signup" className="text-blue-500 dark:text-blue-400 font-medium hover:underline">
              Sign up
            </Link>
          </p>
        </div>
